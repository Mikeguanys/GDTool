...
{
    public class SQLiteBasis : SQLConnection, SQLMethodInterface
    {
        #region 数据库连接属性
        ...
        public SQLiteBasis()
        {
            Connection = new SQLiteConnection(DefConnection);
        }
        /// <summary>
        /// SQLiteBasis(string ConnectinName)
        /// </summary>
        /// <param name="ConnectinName"></param>
        public SQLiteBasis(string ConnectinName)
        {
            ...
            {
                Connection = new SQLiteConnection(ConnectionStr(ConnectinName));
            }
        }
        /// <summary> 
        /// 打开数据库连接 
        ...
        public int BsAddGetId(string SQLString)
        {
            ...
            {
                ConnectionOpen();
                using (Comd = new SQLiteCommand(SQLString, Connection))
                {
        ...
        /// </summary>
        /// <param name="SQLString">SQL语句</param>
        /// <param name="Parameter">SQLiteParameter[]</param>
        /// <returns></returns>
        ...
        public DataSet BsDataSet(string SQLString)
        {
            ...
            {
                ConnectionOpen();
                using (SQLiteDataAdapter rs = new SQLiteDataAdapter(SQLString, Connection))
                {
                    rs.Fill(ds);
                }
                return ds;
        ...
        public DataSet BsDataSet(string SQLString, object Parameter)
        {
            ...
            try
            {
                ...
                {
                    Comd.Parameters.AddRange((Parameter as SQLiteParameter[]));
                    using (SQLiteDataAdapter Adapter = new SQLiteDataAdapter(Comd))
                    {
                        Adapter.Fill(ds);
                    }
        ...
        public DataSet BsStorageDs(string StorageName, object Parameter)
        {
            ...
            try
            {
                ...
                ConnectionOpen();
                using (Comd = new SQLiteCommand(StorageName, Connection))
                {
        ...
        public bool BsTranExecute(string SQLString, int Count = 0)
        {
            ...
            try
            {
                Comd = new SQLiteCommand(SQLString);
