...
namespace GDataBase
{
    public class ImageUtility
    {
        ...
        public Bitmap MergeQrImg(Bitmap qrImg, Bitmap headerImg, double n = 0.23)
        {
            ...
            var _newWidth = (12 * qrImg.Width - 17 * margin) * 1.0f / 36;
            ...
            int a = headerBgImg.Width;
            int b = headerBgImg.Height;
        ...
        private Image ZoomPic(Image initImage, double n)
        {
            ...
            //生成新图
            //新建一个bmp图片
            System.Drawing.Image newImage = new System.Drawing.Bitmap((int)newWidth, (int)newWidth);
            //新建一个画板
