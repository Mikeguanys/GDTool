...
namespace GDataBase
{
    ...
    /// MySQL 数据库操作底层
    /// </summary>
    public class MySQLDBHeper : MySQLBS, IDataBase
    {
        /// <summary>
        /// 方法重构
        /// </summary>
        ...
        /// 方法重构，连接名字
        /// </summary>
        public MySQLDBHeper(string ConnStr) : base(ConnStr)
        {
        ...
        /// <returns></returns>
        public object GetAddGetId(string filename, string valuestr, string tablename, params MySql.Data.MySqlClient.MySqlParameter[] cmdParms)
        {
        ...
        public bool Add(string filename, string valuestr, string tablename, params MySql.Data.MySqlClient.MySqlParameter[] cmdParms)
        {
            string sql = string.Format("insert into {0}({1}) values({2})", tablename, filename, valuestr);
            return BsExecute(sql, cmdParms) > 0;
        }
        ...
        /// <param name="cmdParms">参数</param>
        /// <returns></returns>
        public bool MoreAdd(string filename, List<string> valuestr, string tablename, params MySqlParameter[] cmdParms)
        {
        ...
        {
            string sql = string.Format("insert into {0}({1}) values {2}", tablename, filename, string.Join(",", valuestr));
            return BsMoreExecute(sql, valuestr.Length);
        }
        /// <summary>
        /// 插入多条数据
        /// </summary>
        ...
        /// <param name="cmdParms">参数</param>
        /// <returns></returns>
        public bool Update(string setcondition, string condition, string tablename, params MySql.Data.MySqlClient.MySqlParameter[] cmdParms)
        {
        ...
        /// <param name="cmdParms">参数</param>
        /// <returns></returns>
        public bool Delete(string condition, string tablename, params MySql.Data.MySqlClient.MySqlParameter[] cmdParms)
        {
        ...
        /// <param name="cmdParms">参数</param>
        /// <returns></returns>
        public object GetSingle(string GetColoum, string condition, string tablename, params MySql.Data.MySqlClient.MySqlParameter[] cmdParms)
        {
        ...
        /// <param name="cmdParms">参数</param>
        /// <returns></returns>
        public bool Exists(string contion, string tablename, params MySql.Data.MySqlClient.MySqlParameter[] cmdParms)
        {
        ...
        /// <returns></returns>
        public System.Data.DataTable GetTable(string contion, string tablename, params MySql.Data.MySqlClient.MySqlParameter[] values)
        {
            string sql = string.Format("select * from {0} where 1=1 {1};", tablename, contion);
            return BsGetDataTable(sql, values);
        }
        /// <summary>
        /// 获取多个表
        /// </summary>
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public System.Data.DataSet GetDataSet(string contion, string tablename, params MySql.Data.MySqlClient.MySqlParameter[] values)
        {
            string sql = string.Format("select * from {0} where 1=1 {1};", tablename, contion);
            return BsGetDataSet(sql, values);
        }
        /// <summary>
        /// 获取分页列表
        /// </summary>
        ...
        public void PagingList(ref System.Data.DataTable DataSour, ref int RowCount, int ThisPage, int PageSize, string sql1, string sql2)
        {
            ...
            System.Data.DataSet ds = BsGetDataSet(sql);
            if (ds == null)
            {
                DataSour = null;
                RowCount = 0;
        ...
        public void GetPagingData(ref DataTable dt, ref int RowCount, string ProcName, int ThisPage, string TableName, int PageSize, string Condition, string Sorting)
        {
            MySqlParameter[] parameter = {
                                       new MySqlParameter("@ThisPage",MySqlDbType.Int32),
                                       new MySqlParameter("@PageSize",MySqlDbType.Int32),
                                       new MySqlParameter("@TableName",MySqlDbType.Text),
                                       new MySqlParameter("@Conditions",MySqlDbType.Text),
                                       new MySqlParameter("@Sorting",MySqlDbType.VarChar,50)
                                       };
        ...
        public bool RecordLog(string ActEr, string Act, string Log)
        {
            ...
            MySqlParameter[] parameters = {
                              new MySqlParameter("@F_Sid", MySqlDbType.Int32,11),
                              new MySqlParameter("@F_Act", MySqlDbType.VarChar,32),
                              new MySqlParameter("@F_log", MySqlDbType.VarChar,1024)
                                          };
        ...
        public T GTSearch<T>(string sql) where T : new()
        {
            ...
            {
                DataRow dr = BsGetDataReader(sql);
                if (dr == null)
                {
                    return default(T);
                }
        ...
        /// <returns></returns>
        public T GTSearch<T>(string sql, MySqlParameter[] par) where T : new()
        {
            if (string.IsNullOrEmpty(sql))
            {
                return default(T);
            ...
            {
                DataRow dr = BsGetDataReader(sql, par);
                if (dr == null)
                {
                    return default(T);
                }
        ...
        /// <param name="sql">SQL语句</param>
        /// <returns></returns>
        public List<T> GTList<T>(string sql) where T : new()
        {
            List<T> lt = new List<T>();
            DataTable dt = BsGetDataTable(sql);
        ...
        /// <returns></returns>
        public List<T> GTSearchList<T>(string sql, MySqlParameter[] par) where T : new()
        {
            List<T> lt = new List<T>();
            DataTable dt = BsGetDataTable(sql, par);
            if (dt == null || dt.Rows.Count == 0)
            {
                return null;
            }
